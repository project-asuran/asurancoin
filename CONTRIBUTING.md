Contributing to Asurancoin Core
============================

The Asurancoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Asurancoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/asurancoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to asurancoin-qt
...
The following applies to code changes to the Asurancoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Asurancoin
Network Protocol consensus changes.

Whether a pull request is merged into Asurancoin Core rests with the project merge
...
Patches that change Asurancoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Asurancoin consensus, it must have been
...
The project leader is the release manager for each Asurancoin Core release.
