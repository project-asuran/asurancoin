...
"""Verify that starting asurancoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start asurancoin with -h for help text")
        ...
        self.log.info("Start asurancoin with -version for version information")
        ...
        self.log.info("Start asurancoind with -fakearg to make sure it does not start")
