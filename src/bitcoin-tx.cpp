...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " asurancoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  asurancoin-tx [options] <hex-tx> [commands]  Update hex-encoded asurancoin transaction\n" +
            "or:     asurancoin-tx [options] -create [commands]   Create hex-encoded asurancoin transaction\n" +
            "\n";
