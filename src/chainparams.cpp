...
{
    const char* pszTimestamp = "True revolutionary is guided by great feelings of love, Che Guevara";
    const CScript genesisOutputScript = CScript() << ParseHex("141184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1672974745, 2000565179, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x275c6b1b44aea785ada568e3c64252a23b7200feca7f3d78c1616401a0f8c8a5"));
        assert(genesis.hashMerkleRoot == uint256S("0x394ef6607e50012c90ed86835ad4411fa2aef3fdb4db90eb664f47883ef30dfa"));
        ...
        checkpointData = {
            {
                {     0, uint256S("0x275c6b1b44aea785ada568e3c64252a23b7200feca7f3d78c1616401a0f8c8a5")},
...
public:
    CTestNetParams() {
       ...
       // consensus.defaultAssumeValid = uint256S("0x4a280c0e150e3b74ebe19618e6394548c8a39d5549fd9941b9c431c73822fbd5"); // 1737876
        ...
        genesis = CreateGenesisBlock(1672974745, 1016918, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6d268964eeef46eab7b0c490993fd20f26600805a2e75fb25477bf6ab960d564"));
        assert(genesis.hashMerkleRoot == uint256S("0x394ef6607e50012c90ed86835ad4411fa2aef3fdb4db90eb664f47883ef30dfa"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x6d268964eeef46eab7b0c490993fd20f26600805a2e75fb25477bf6ab960d564")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
       ...
       // consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        ...
        genesis = CreateGenesisBlock(1672974745, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf87f1912ae53af198b3734403599330020ef79f50fec8b2146bf29bfdae641de"));
        assert(genesis.hashMerkleRoot == uint256S("0x394ef6607e50012c90ed86835ad4411fa2aef3fdb4db90eb664f47883ef30dfa"));
        ...
        checkpointData = {
            {
                {0, uint256S("0xf87f1912ae53af198b3734403599330020ef79f50fec8b2146bf29bfdae641de")},
            }
        };
