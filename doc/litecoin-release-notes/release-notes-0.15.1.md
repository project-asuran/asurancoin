Asurancoin Core version *0.15.1* is now available from:

  <https://download.asurancoin.org/asurancoin-0.15.1/>
...
A number of changes to the way Asurancoin Core deals with peer connections and invalid blocks
