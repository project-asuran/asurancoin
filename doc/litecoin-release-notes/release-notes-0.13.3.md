Asurancoin Core version 0.13.3 is now available from:

  <https://download.asurancoin.org/asurancoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/asurancoin-project/asurancoin/blob/0.13/src/chainparams.cpp#L214).
