# Support for Output Descriptors in Asurancoin Core

Since Asurancoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Asurancoin Core wallets, a convenience function `combo` is
